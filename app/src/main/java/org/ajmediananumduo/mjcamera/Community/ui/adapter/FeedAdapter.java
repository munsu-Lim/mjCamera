...
public class FeedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void bindLoadingFeedItem(final LoadingCellFeedViewHolder holder) {
        holder.loadingFeedItemView.setOnLoadingFinishedListener
                (new org.ajmediananumduo.mjcamera.Community.ui.view.LoadingFeedItemView.OnLoadingFinishedListener() {
            @Override
    ...
    public static class LoadingCellFeedViewHolder extends CellFeedViewHolder {
        ...
        org.ajmediananumduo.mjcamera.Community.ui.view.LoadingFeedItemView loadingFeedItemView;

        public LoadingCellFeedViewHolder(org.ajmediananumduo.mjcamera.Community.ui.view.LoadingFeedItemView view) {
            super(view);
